(function (global, factory) {
  ...
  */
  ...
  var checkbox = function checkbox(_ref2) {
      ...
      return html$1(_templateObject3, label, checked, cn('input', classname), label, name, (label || children) && html$1(_templateObject4, label || children));
  };
      ...
      createClass(PollElement, [{
          ...
          value: function _renderResult(data) {
              ...
              var _result = function _result(_data, _css) {
                  ...
                  return html$1(_templateObject8, classString((_classString = {}, defineProperty(_classString, cn(_css.text), true), defineProperty(_classString, _css.active, data.winner), _classString)), _data.label, cn(_css.aftertext), parseFloat(_data.value * 1e2).toFixed(1));
              };
