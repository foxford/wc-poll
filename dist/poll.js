    ...
    createClass(PollElement, [{
      ...
      value: function _renderResult(data) {
        ...
        var _result = function _result(_data, _css) {
          ...
          return html$1(_templateObject2$2, classString((_cs = {}, defineProperty(_cs, cn(_css.text), true), defineProperty(_cs, _css.active, data.winner), _cs)), _data.label, cn(_css.aftertext), parseFloat(_data.value * 1e2).toFixed(1));
        };
