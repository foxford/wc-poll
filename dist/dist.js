(function (global, factory) {
  ...
  */
    ...
    createClass(NodePart, [{
      ...
      value: function _setPromise(value) {
        ...
        value.then(function (v) {
          if (_this6._previousValue === value) {
            _this6.setValue(v);
          }
        });
      }
   ...
   */
  var svg$1 = function svg$1(strings) {
    for (var _len2 = arguments.length, values = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
      values[_key2 - 1] = arguments[_key2];
    }

    return new SVGTemplateResult(strings, values, 'svg', extendedPartCallback);
  };
  /**
  ...
  var LitElement = function (_PropertiesMixin) {
    ...
    function LitElement() {
      ...
      var _this9 = possibleConstructorReturn(this, (LitElement.__proto__ || Object.getPrototypeOf(LitElement)).apply(this, arguments));

      _this9.__renderComplete = null;
      _this9.__resolveRenderComplete = null;
      _this9.__isInvalid = false;
      _this9.__isChanging = false;
      return _this9;
    }
    /**
      ...
      get: function get$$1() {
        ...
        if (!this.__renderComplete) {
          this.__renderComplete = new Promise(function (resolve) {
            _this10.__resolveRenderComplete = function (value) {
              _this10.__resolveRenderComplete = _this10.__renderComplete = null;
              resolve(value);
            };
          });
          if (!this.__isInvalid && this.__resolveRenderComplete) {
            Promise.resolve().then(function () {
              return _this10.__resolveRenderComplete(false);
            });
          }
        }
  ...
  var css$1$1 = { "root": "checkbox_root__2vRI1", "_$root": "checkbox_root__2vRI1" };
  ...
  var checkbox = function checkbox(_ref2) {
    ...
    return html$1(_templateObject2, 'root size-medium ' + css$1$1.root, label, checked, cn('input', classname), label, name, value, (label || children) && html$1(_templateObject3, label || children));
  };
  ...
  var css$2 = { "root": "progress_root__2xqYW", "bar": "progress_bar__2vGxy", "active": "progress_active__3vz-l", "selected": "progress_selected__1zSXk", "_$root": "progress_root__2xqYW", "_$bar": "progress_bar__2vGxy", "_$active": "progress_active__3vz-l", "_$selected": "progress_selected__1zSXk" };
  ...
  var progress = function progress(_ref3) {
    ...
    var active = _ref3.active,
        ...
        width = _ref3.width;
    return html$1(_templateObject4, cn(css$2.root, ui$1.root, classname, classString((_classString = {}, defineProperty(_classString, css$2.active, active), defineProperty(_classString, css$2.selected, selected), _classString))), children, cn(css$2.bar, ui$1.bar), width);
  };
  ...
  var css$3 = { "root": "radio_root__37Zse", "label": "radio_label__2o1Gp", "_$root": "radio_root__37Zse", "_$label": "radio_label__2o1Gp" };

  var radio = svg$1(_templateObject5);

  var radioChecked = svg$1(_templateObject6);

  var radio$1 = function radio$1(_ref4) {
    ...
    return html$1(_templateObject7, cn(ui$2.root, ui$2['size-medium'], css$3.root), label, checked, cn(ui$2.input, css$3.input, classname), label, name, value, radio, radioChecked, (label || children) && html$1(_templateObject8, cn(ui$2.label, css$3.label), label || children));
  };
      ...
      return function (_base2) {
        ...
        createClass(_class, [{
          ...
          value: function __renderStyles() {
            for (var _len5 = arguments.length, argv = Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
              argv[_key5] = arguments[_key5];
            }

            // eslint-disable-line class-methods-use-this
            return html(_templateObject11, argv.join(' '));
          }
        }, {
          key: '_render',
          value: function _render(props) {
            return html(_templateObject12, this.__renderStyles.apply(this, styles), get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), '_render', this).call(this, props));
          }
        }]);
        return _class;
      }(base);
  ...
  var withStyleLink = function withStyleLink(html) {
    return function (base) {
      for (var _len6 = arguments.length, links = Array(_len6 > 1 ? _len6 - 1 : 0), _key6 = 1; _key6 < _len6; _key6++) {
        links[_key6 - 1] = arguments[_key6];
      }
      ...
      return function (_base3) {
        ...
        createClass(_class2, [{
          ...
          value: function __renderStyleLink() {
            for (var _len7 = arguments.length, argv = Array(_len7), _key7 = 0; _key7 < _len7; _key7++) {
              argv[_key7] = arguments[_key7];
            }

            // eslint-disable-line class-methods-use-this
            return argv.map(function (link) {
              return html(_templateObject13, link);
            });
          }
        }, {
          key: '_render',
          value: function _render(props) {
            return html(_templateObject12, this.__renderStyleLink.apply(this, links), get(_class2.prototype.__proto__ || Object.getPrototypeOf(_class2.prototype), '_render', this).call(this, props));
          }
        }]);
        return _class2;
      }(base);
  ...
  var withPoll = function withPoll(base) {
    ...
    return function (_base4) {
      inherits(_class3, _base4);

      function _class3(props) {
        classCallCheck(this, _class3);

        var _this13 = possibleConstructorReturn(this, (_class3.__proto__ || Object.getPrototypeOf(_class3)).call(this, props));

        Object.keys(initialConfig).map(function (it) {
          _this13[it] = initialConfig[it];
  ...
  var PollElement = function (_LitElement) {
    ...
    function PollElement(props) {
      ...
      var _this14 = possibleConstructorReturn(this, (PollElement.__proto__ || Object.getPrototypeOf(PollElement)).call(this, props));

      _this14.users = [];
      _this14.selected = false;
      _this14.list = [];
      _this14.result = {
        total: 0,
        list: []
      ...
      _this14._boundVariantChange = _this14._onVariantChange.bind(_this14);
      _this14._boundRenderVariant = _this14._renderVariant.bind(_this14);
      _this14._boundRenderResult = _this14._renderResult.bind(_this14);
      _this14._boundPollComplete = _this14._onPollComplete.bind(_this14);
      return _this14;
    }
    ...
    createClass(PollElement, [{
      ...
      value: function _aggregateResult(values, names) {
        ...
        values.map(function (it) {
          ...
          _this15.list = _this15.list.map(function (that) {
      ...
      value: function _renderVariant(data) {
        ...
        return html$1(_templateObject14, cn(enh['margin-bottom-12']), this._boundVariantChange, variantEl(data));
      }
    }, {
      key: '_renderResult',
      ...
      value: function _render(_ref8) {
        ...
        return html$1(_templateObject15, css$4.root, css$4.image, pollImage, css$4.content, css$4.question, text, poll, children);
      }
    }]);
    return PollElement;
  }(LitElement);
