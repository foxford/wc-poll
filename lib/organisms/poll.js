...
import { actions } from '../atoms/poll.actions'
...
import * as action from '../molecules/poll.action'
import pollImage from '../images/poll.svg'
import { _withActions, _withPermissions } from '../utils/mixins'
...
export const withActions = _withActions(html)

export const withPermissions = _withPermissions(html)
